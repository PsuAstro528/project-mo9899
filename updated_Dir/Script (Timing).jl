...
num_gh_orders)
fitted_timing_serial = @benchmark fit_lines_v0_serial(λ_lines,df.λ,df.flux,df.var, order = num_gh_orders)
...
timing_parallel = @benchmark fit_lines_v0_parallel(λ_lines,df.λ,df.flux,df.var, order = num_gh_orders)
